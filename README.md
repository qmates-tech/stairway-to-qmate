...
### 1) Methodology
* Read [The Agile Manifesto](https://agilemanifesto.org/) and the [Twelve Principles](https://agilemanifesto.org/principles.html) behind it: read also about the [History](https://agilemanifesto.org/history.html) if you want to know more ```#onboarding```
